...
u8 _by_Pattern0_Setup_dut0()
{
	...
	case 0x0003:
	{
		...
		else
		{
			...
			else
			{
				...
				xil_printf("dut0 get IC information fail!!!\r\n\r\n");
			}
	...
	case 0x0005:
	{
		...
		else
		{
			...
			{
				//XGpio_WriteBit(XPAR_AXI_GPIO_dut0_1_BASEADDR,0,26, ~gpio26_output_value);
			...
			if(efuse_package_valid==0)
			{
				...
				xil_printf("dut0 -> this is a new ic without package code, go to pattern12!\r\n\r\n");
			}
			else if((efuse_package_valid!=0) && (efuse_writedata_valid==0))
			{
				...
				if(ft1_config_scan == 0xffffffff)
				{
					...
					xil_printf("dut0 -> this is a new ic with package code, but gpio22 is high, go to pattern12!\r\n\r\n");
				}
				else
				{
					...
					dut0.g_uartPatternNum = (dut0.g_uartPatternNum++ & 0xff);
					//dut0.g_uartPatternNum = (dut0.g_uartPatternNum++ & 0xff);
					xil_printf("dut0 -> this is a new ic with package code and gpio22 is low, go to pattern1!\r\n\r\n");
				}
			}
			else if((efuse_package_valid!=0) && (efuse_writedata_valid==1))
			{
				...
				if(ft1_config_scan == 0xffffffff)
				{
					...
					dut0.g_uartPatternNum = (0x0c & 0xff);
					//dut0.g_uartPatternNum = (dut0.g_uartPatternNum++ & 0xff);
					xil_printf("dut0 -> this is a retest ic and gpio22 is high, go to pattern12!\r\n\r\n");
				}
				else
				{
					...
					dut0.g_uartPatternNum = (dut0.g_uartPatternNum++ & 0xff);
					//dut0.g_uartPatternNum = (dut0.g_uartPatternNum++ & 0xff);
					xil_printf("dut0 -> this is a retest ic and gpio22 is low, go to pattern1!\r\n\r\n");
				}
			}
			else
			{
