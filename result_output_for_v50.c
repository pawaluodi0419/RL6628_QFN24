...
void result_output_for_v50(u32 XGPIO_BASEADDR,u8 result_data)
{
	...
	XGpio_WriteReg(XGPIO_BASEADDR,XGPIO_TRI_OFFSET+XGPIO_ChOffset,a&~(0xf<<17));
	usdelay(10);
	XGpio_WriteReg(XGPIO_BASEADDR,XGPIO_TRI_OFFSET+XGPIO_ChOffset,a&~(0xf<<17));
	...
	//keep gpio data besides gpio17~20
	write_result_data = ((a&(~(0xf<<17))) | ((result_data&0xf)<<17));

	//write gpio data 17~20
	...
	//xil_printf("b = 0x%x\r\n",b);
	//xil_printf("writedata = 0x%x gpio17~20 = 0x%x\r\n",b,(b>>17)&0x0f);
