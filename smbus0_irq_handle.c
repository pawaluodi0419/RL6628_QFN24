...
u8 smbus0_irq_handle(u8 smbus_control_buf[])
{
	...
	//smbus_read//
	if((smbus0_cmd_code & 0x30) == 0x30)
	{
		switch(smbus0_process_state){

		case smbus_road_waiting:
		{
			//xil_printf("\r\n dut0_smbus_road_waiting_doing_read_case0000\r\n");
			dut0.g_smbus_status_buf[0] = CLEAR_;
			dut0.g_smbus_status_buf[1] = CLEAR_;
			dut0.g_smbus_status_buf[2] = CLEAR_;
	...
	////////xil_printf("dut0_smbus_result = %x\r\n", dut0.g_smbus_status_buf[0]);
	//////////xil_printf("dut0_smbus_timer = %x\r\n", dut0.g_smbus_timer);
	//////xil_printf("dut0_Ackbit = %x\r\n", Ackbit);
	//xil_printf("smbus0_process_state = %x\r\n", smbus0_process_state);
