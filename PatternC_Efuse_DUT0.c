...
u8 _by_Pattern12_efuse_dut0()
{
	...
	case 0x0000:
	{
		   ...
		   else
		   {
			   ...
			   if((efuse_package_valid==0) && (efuse_writedata_valid==0))
			   {
			       ...
			       //dut0.g_pattern_step++;
			       xil_printf("dut0 -> this is a new ic without package code, go to write package code!\r\n\r\n");
			   ...
			   else if((efuse_package_valid!=0) && (efuse_writedata_valid==0))
			   {
				   ...
				   if(START01_GPIO22 == 1)
				   {
				       ...
				       dut0.g_pattern_step = 0x0200;
				       //dut0.g_pattern_step++;
				       xil_printf("dut0 -> this is a new ic with package code, but gpio22 is high, go to write package code!\r\n\r\n");
				   }
				   else
				   {
				       ...
				       dut0.g_pattern_step++;
				       xil_printf("dut0 -> this is a new ic with package code and gpio22 is low, go to write efuse!\r\n\r\n");
				   }
			   ...
			   else if((efuse_package_valid!=0) && (efuse_writedata_valid==1))
			   {
				   ...
				   if(START01_GPIO22 == 1)
				   {
				       ...
				       dut0.g_pattern_step = 0x0200;
				       //dut0.g_pattern_step++;
				       xil_printf("dut0 -> this is a retest ic, but gpio22 is high, go to write package code!\r\n\r\n");
				   }
				   else
				   {
					   ...
					   //dut0.g_pattern_step++;
					   xil_printf("dut0 -> this is a retest ic and gpio22 is low, go to start tolerance compare!\r\n\r\n");
				   }
	...
	case 0x0001:
	{
		   ...
		   dut0.g_efuse_temp_buf[0] = ((QFN24_Package_Num<<4)|0x0f);                             //efuse validbit
		   dut0.g_efuse_temp_buf[1] = (dut0.g_retest<<7|0x0c);                                   //efuse validbit
		   dut0.g_efuse_temp_buf[2] = 0x40|dut0.g_efuse_data_ldo3v3;                             //efuse ldo3v3 data bit0~3
		                                                                                         //efuse vbus ocp validbit
		   dut0.g_efuse_temp_buf[3] = 0xe0;                                                      //efuse vmon comparitor
                                                                                                 //efuse vbus threshould
		   dut0.g_efuse_temp_buf[4] = (dut0.g_efuse_data_buf[5]<<5 | dut0.g_efuse_data_buf[6]);  //efuse rp data
	       ...
	       dut0.g_efuse_temp_buf[25] = 0x2A;                            						//vbus ocp3A                                       //efuse vbus ocp 3A
		   dut0.g_efuse_temp_buf[26] = dut0.g_vbusocp_writeefuse_1p5a;                          //vbus ocp1p5A                                                   //efuse vbus ocp 1.5A
		   dut0.g_efuse_temp_buf[27] = dut0.g_vbusocp_writeefuse_0p9a;                          //vbus ocp0p9A
                                                    //efuse vbus ocp 0.9A
	...
	case 0x0002:
	{
		   ...
		   //////////xil_printf("dut0_pattern0_write_efuse_data00\r\n");
	break;
	}
	...
	case 0x0004:
	{
		   ...
		   //////////xil_printf("dut0_pattern0_write_efuse_data02\r\n");
	break;
	}
	...
	case 0x0005:
	{
		   ...
		   else
		   {
			   ...
			   if(dut0.g_efuse_temp_buf[i] != dut0.g_pattern_smbus_control_buf[i+10])
			   {
				   efuse_compare_bit = 1;
				   dut0.g_result_fail = 0x01;
				   dut0.g_result_fail_tmrcount = 0xffff;
	...
	case 0x0006:
	{
		   ...
		   else
		   {
			   ...
			   for(i=0;i<10;i++)
			   {
			   if(dut0.g_efuse_temp_buf[i+10] != dut0.g_pattern_smbus_control_buf[i+10])
			   {
				   efuse_compare_bit = 1;
				   dut0.g_result_fail = 0x01;
				   dut0.g_result_fail_tmrcount = 0xffff;
	...
	case 0x0100:
	{
		...
		else
		{
			...
			for(i=0;i<10;i++)
			{
				xil_printf("dut0.efuse_read[i] =0x%x i =0x%x\r\n", efuse_read_buf[i],i);
			}
			//for(i=0;i<10;i++)
			//{
			   //xil_printf("dut0.g_efuse_temp_buf[i] =%x %x\r\n", dut0.g_efuse_temp_buf[i],i);
...
*/
	...
	case 0x0200:
	{
		   ...
		   dut0.g_pattern_smbus_control_buf[3] = 0x00;
		   dut0.g_pattern_smbus_control_buf[4] = 0x01;
		   dut0.g_pattern_smbus_control_buf[5] = (QFN24_Package_Num<<4);  //0x20:RL6628 QFN20 package number
