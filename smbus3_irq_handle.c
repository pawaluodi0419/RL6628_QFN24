...
u8 smbus3_irq_handle(u8 smbus_control_buf[])
{
	...
	//smbus_read//
	if((smbus3_cmd_code & 0x30) == 0x30)
	{
		switch(smbus3_process_state){

		case smbus_road_waiting:
		{
			//xil_printf("\r\n dut3_smbus_road_waiting_doing_read_case00\r\n");
			dut3.g_smbus_status_buf[0] = CLEAR_;
			dut3.g_smbus_status_buf[1] = CLEAR_;
			dut3.g_smbus_status_buf[2] = CLEAR_;
	...
	////////xil_printf("dut3_smbus_result = %x\r\n", dut3.g_smbus_status_buf[0]);
	//////////xil_printf("dut3_smbus_timer = %x\r\n", dut3.g_smbus_timer);
	//////xil_printf("dut3_Ackbit = %x\r\n", Ackbit);
	//xil_printf("smbus3_process_state = %x\r\n", smbus3_process_state);
