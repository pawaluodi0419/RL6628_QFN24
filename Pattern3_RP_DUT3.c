...
u8 _by_Pattern3_RPcalibration_dut3()
{
	...
	case 0x0100:
	{
		   ...
		   //////////////xil_printf("\r\n dut3_pattern2_0xC1AE_be_writen\r\n");
	...
	case 0x0101:
	{
		   ...
		   //////////////xil_printf("dut3_pattern2_0xC108_be_writen\r\n");
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		   break;
	}
	...
	case 0x0102:
	{
		   ...
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern2_0x1022/1023_be_writen\r\n\r\n");
		   break;
	}
	...
	case 0x0200:
	{
    	...
    	dut3.g_dut_pattern_status_buf[17] = (rp4p7k_min & 0xFF);
    	dut3.g_dut_pattern_status_buf[18] = (rp4p7k_min & 0xFF00)>>8;
    	dut3.g_dut_pattern_status_buf[19] = (rp4p7k_max & 0xFF);
    	dut3.g_dut_pattern_status_buf[20] = (rp4p7k_max & 0xFF00)>>8;

    	dut3.g_dut_pattern_status_buf[21] = (rp36k_min & 0xFF);
    	dut3.g_dut_pattern_status_buf[22] = (rp36k_min & 0xFF00)>>8;
    	dut3.g_dut_pattern_status_buf[23] = (rp36k_max & 0xFF);
    	dut3.g_dut_pattern_status_buf[24] = (rp36k_max & 0xFF00)>>8;

    	dut3.g_pattern_step++;
		//////////////xil_printf("dut3_pattern2_read_LDO3V3\r\n\r\n");
    	//////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		break;
	}
	...
	case 0x0201:
	{
    	...
    	//write to phy 0x106 default data
		   ...
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
			//////////////xil_printf("dut3_pattern2_write_0x106_default_data\r\n");
		break;
	}
	...
	case 0x0202:
	{
    	...
    	rp12k_max = (u16)(dut3.g_dut_pattern_status_buf[16]<<8 | dut3.g_dut_pattern_status_buf[15]);
	       ...
	       dut3.g_pattern_step++;
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
	       //////////////xil_printf("dut3_pattern2_read_cc1_rp12k_default_voltage\r\n");
	break;
	}
	...
	case 0x0203:
	{
		...
		else
		{
		   ...
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		//////////////xil_printf("dut3_pattern2_write_cc1_rp12k_0x106\r\n");
		break;
	}
    	...
    	if((dut3.g_dut_pattern_status_buf[31] >= 0) && (dut3.g_dut_pattern_status_buf[31]<= 0x0F))
    	{
    		...
    		else if(cc1_rp_voltage < rp12k_ref)
    		{
				...
				dut3.g_pattern_step++;
    				...
    				//////////////xil_printf("dut3_pattern2_read_cc1_rp12k_calibration_voltage\r\n");
			    break;
    			}
	...
	case 0x0205:
	{
		   ...
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern2_write_cc1_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0206:
	{
		   ...
		   //////////////xil_printf("dut3_pattern2_read_cc1_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0300:
	{
		  ...
		  smbus3_irq_handle(dut3.g_pattern_smbus_control_buf);
		   ...
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern2_write_cc2_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0301:
	{
    	...
    	rp12k_max = (u16)(dut3.g_dut_pattern_status_buf[16]<<8 | dut3.g_dut_pattern_status_buf[15]);
	       ...
	       //////////////xil_printf("rp12k_max = %d\r\n",rp12k_max );
			...
			////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
			//////////////xil_printf("dut3_pattern2_read_cc2_rp12k_voltage\r\n");
	break;
	}
	...
	case 0x0400:
	{
		  ...
		  smbus3_irq_handle(dut3.g_pattern_smbus_control_buf);
		   ...
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern2_write_cc2_rp12k_calibration_0x1022\r\n");
	break;
	}
	...
	case 0x0401:
	{
		  ...
		  smbus3_irq_handle(dut3.g_pattern_smbus_control_buf);
		   ...
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern2_write_cc1_rp36k_calibration_0x107\r\n");
	break;
	}
	...
	case 0x0402:
	{
		_byAD7994ReadCvsData_dut3(AD7994_ADC1_SLAVE_ADDR,0x01, 5);
      	...
      	rp36k_min = (u16)(dut3.g_dut_pattern_status_buf[22]<<8 | dut3.g_dut_pattern_status_buf[21]);
      	rp36k_max = (u16)(dut3.g_dut_pattern_status_buf[24]<<8 | dut3.g_dut_pattern_status_buf[23]);
      	...
      	////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
      	//////////////xil_printf("dut3_pattern2_read_cc1_rp36k_calibration_voltage\r\n");
	break;
	}
	...
	case 0x0403:
	{
		_byAD7994ReadCvsData_dut3(AD7994_ADC1_SLAVE_ADDR,0x03, 5);
      	...
      	////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
      	//////////////xil_printf("dut3_pattern2_read_cc2_rp36k_calibration_voltage\r\n");
	break;
	}
	...
	case 0x0500:
	{
		   ...
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern2_write_cc2_rp4.7k_calibration_0x1022\r\n");
		   break;
	}
	...
	case 0x0501:
	{
		   ...
		   //xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern2_write_cc1_rp36k_calibration_0x108\r\n");
	break;
	}
	...
	case 0x0502:
	{
		_byAD7994ReadCvsData_dut3(AD7994_ADC1_SLAVE_ADDR,0x01, 5);
      	...
      	rp4p7k_min = (u16)(dut3.g_dut_pattern_status_buf[18]<<8 | dut3.g_dut_pattern_status_buf[17]);
      	rp4p7k_max = (u16)(dut3.g_dut_pattern_status_buf[20]<<8 | dut3.g_dut_pattern_status_buf[19]);
		...
		//xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		//////////////xil_printf("dut3_pattern2_read_cc1_rp4.7k_calibration_voltage\r\n");
		break;
	}
	case 0x0503:
	{
		...
		//xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		//////////xil_printf("dut3_pattern2_read_cc2_rp4.7k_calibration_voltage\r\n\r\n");
	...
	if(dut3.g_result_fail == 0x01)
	{
	    ...
	    xil_printf("dut3_cc_rp_voltage = %x\r\n\r\n",cc_rp_voltage);
	}
