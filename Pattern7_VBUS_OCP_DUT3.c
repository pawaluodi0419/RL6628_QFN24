...
u8 _by_Pattern7_VBUS_OCP_dut3()
{
	...
	case 0x0001:
	{
		...
		dut3.g_vbusocp_1p5a_nmos_control = 0;
	...
	case 0x0002:
	{
		...
		if(dut3.g_vbusocp_process_bit != vbusocp_process_done_pass)
		{
			if((dut3.g_vbusocp_step==0x09)&&(dut3.g_vbusocp_readadc_ready == 1))
			{
				_byAD7994ReadCvsData_dut3(AD7994_ADC2_SLAVE_ADDR,0x07, 5);
	...
	case 0x0003:
	{
		...
		else
		{
			...
			{
				//dut3.g_vbusocp_3a_done = 0x01;
				dut3.g_pattern_step++;
				xil_printf(">>>>>>>>>> dut3_pattern7_vbus_ocp_3a_test_pass!\r\n\r\n");
			}
			else
			{
				dut3.g_result_fail = 0x01;
	...
	case 0x0004:
	{
		...
		xil_printf("dut3_pattern7_vbusocp_calibration_pass!\r\n");
		xil_printf("dut3_efuse_0p9a=0x%x,efuse_1p5a=0x%x\r\n\r\n",dut3.g_vbusocp_writeefuse_0p9a,dut3.g_vbusocp_writeefuse_1p5a);
